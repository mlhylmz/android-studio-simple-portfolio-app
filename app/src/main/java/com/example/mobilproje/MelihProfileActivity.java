...
public class MelihProfileActivity extends AppCompatActivity {
    ...
    public void openMelihPersonActivity(){
        Intent intent = new Intent(this, MelihPersonal.class);
