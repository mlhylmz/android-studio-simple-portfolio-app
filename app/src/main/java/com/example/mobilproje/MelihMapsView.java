...
import com.example.mobilproje.databinding.ActivityMelihMapsViewBinding;

public class MelihMapsView extends FragmentActivity implements OnMapReadyCallback {

    private GoogleMap mMap;
    private ActivityMelihMapsViewBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        binding = ActivityMelihMapsViewBinding.inflate(getLayoutInflater());
